# Assignment 3 for CS 480
TLDR; Produces an AST tree using graphviz. Code does not free memory, do not use it for production systems.
To build and compare against expected output run `make test`.
